...
//			htmlContent: '<p class="downwarp-progress"></p><p class="downwarp-tip">下拉刷新 </p>',
			htmlContent: '<div class="weui-loadmore"><i class="weui-loading"></i><span class="weui-loadmore__tips">下拉刷新</span></div>',
			inited: function(d, c) {
...
//			htmlNodata: '<p class="upwarp-nodata">我是有底线的</p>',
            htmlLoading: '<div class="weui-loadmore"><i class="weui-loading"></i><span class="weui-loadmore__tips">正在加载</span></div>',
			htmlNodata: '<div class="weui-loadmore weui-loadmore_line"><span class="weui-loadmore__tips">我是有底线的</span></div>',
			inited: function(d, e) {},
