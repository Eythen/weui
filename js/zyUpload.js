...
//					html += '				<div class="btns">';
//					html += '					<div class="review">开始上传</div>';
//					html += '				</div>';
//					html += '			</div>';
//				    html += '			<div id="preview" class="upload_preview"></div>';
					html += '		</div>';
...
//					html += '			</div>';
					...
					html += '					<div style="height:' + para.itemHeight + ';width:' + para.itemWidth + ';" title="点击添加文件" id="rapidAddImg" class="add_imgBox twobi">';
...
//					html += '		</div>';
			...
			this.funDisposePreviewHtml = function(file, e) {
				var html = "";
				var imgWidth = parseInt(para.itemWidth.replace("px", "")) - 0;
				...
				if(file.type.indexOf("image") == 0) {
					...
					html += '		</div>';
					html += '	</div>';
					html += '	<div style="height:' + para.itemHeight + ';width:' + para.itemWidth + ';" href="#" class="imgBox twobi">';
					html += '		<div class="uploadImg" style="width:' + imgWidth + 'px">';
